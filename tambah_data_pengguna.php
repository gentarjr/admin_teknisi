        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <table>
                ...
                <tr><td>NAMA LENGKAP</td><td><input type="text" name="nama_lengkap" class="form-control"></td></tr>
                <tr><td>EMAIL</td><td><input type="text" name="email" class="form-control"></td></tr>
                <tr><td>NOMOR TELP</td><td><input type="text" name="no_telp" class="form-control"></td></tr>
                <tr><td>DIVISI</td><td><select name="divisi" class="form-control">
                  <option value="IT">IT</option>
                  <option value="JARINGAN">JARINGAN</option>
                  <option value="INFRASTRUKTUR">INFRASTRUKTUR</option>
                </select></td></tr>
                <tr><td>HAK AKSES</td><td><select name="hak_akses" class="form-control">
