...
$id         = $_GET['id'];
$data_laporan  = mysqli_query($connect, "select * from nama_kegiatan where id='$id'");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div>
                <form method="post" action="edit_nama_kegiatan.php">
            ...
            <table>
                ...
                <tr><td colspan="2"><button class="btn btn-success" type="submit" value="simpan">SAVE</button>
                        <a  class="btn btn-success" href="nama_kegiatan.php">Kembali</a></td></tr>
            </table>
        </form>
              </div>
            </div>
