      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div>
                <form method="post" action="simpan_jadwal_piket.php">
            <table>
                <tr><td>TEKNISI</td><td><input type="text" name="teknisi" class="form-control"></td></tr>
                <tr><td>NIP</td><td><input type="text" name="nip" class="form-control"></td></tr>
                <tr><td>JAM</td><td><input type="time" name="jam" class="form-control"></td></tr>
